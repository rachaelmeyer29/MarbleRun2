...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    public abstract class ContinuousTurnProviderBase2 : LocomotionProvider
    {
        public ActionBasedContinuousTurnProvider2 ActionBasedContinuousTurnProvider2;
        ...
        protected void TurnRig(float turnAmount)
        {
            ...
            {
                var target = ActionBasedContinuousTurnProvider2.originRotation;
                var xrOrigin = system.xrOrigin;
                if (xrOrigin != null)
                {
                    m_IsTurningXROrigin = true;
                    xrOrigin.transform.RotateAround(target.transform.position, Vector3.up, -turnAmount);
